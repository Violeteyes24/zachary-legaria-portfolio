...
description: PROACTIVELY use this agent when receiving user feedback, planning features, or after launches. This agent MUST BE USED to analyze feedback from multiple sources, identify patterns, synthesize insights from reviews, and prioritize development based on user input. Excels at turning raw feedback into actionable product insights. Examples:\n\n<example>\nContext: Weekly review of user feedback
